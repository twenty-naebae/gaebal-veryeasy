...
public enum HubLocation {
    SEOUL_CENTER("서울특별시 센터", "서울특별시 송파구 송파대로 55", 37.4742027808565, 127.123621185562),
    GYEONGGI_NORTH_CENTER("경기 북부 센터", "경기도 고양시 덕양구 권율대로 570", 37.6403771056018, 126.87379545786),
    GYEONGGI_SOUTH_CENTER("경기 남부 센터", "경기도 이천시 덕평로 257-21", 37.1896213142136, 127.375050006958),
    ...
    JEONNAM_CENTER("전라남도 센터", "전남 무안군 삼향읍 오룡길 1", 34.8174727676363, 126.465415935304),

...
@Slf4j
public class RefillStockService {

    private final HubProductListRepository hubProductListRepository;
    private final RedisTemplate<String, String> redisTemplate;
    private final RedissonClient redissonClient;

    public void refillStock(List<ReservationDto> reservations) {
        ...
        try {
            List<UUID> sortedProductIds = acquiresLock(productQuantities, locks);
